...
public partial class GameEntity {
    ...
    public void AddWeapon(bool newIsRanged, UnityEngine.Transform newAttackPoint, Game.Scripts.Core.Projectile newPrefab) {
        var index = GameComponentsLookup.Weapon;
        var component = (WeaponComponent)CreateComponent(index, typeof(WeaponComponent));
        component.IsRanged = newIsRanged;
        component.AttackPoint = newAttackPoint;
        component.Prefab = newPrefab;
        AddComponent(index, component);
    }

    public void ReplaceWeapon(bool newIsRanged, UnityEngine.Transform newAttackPoint, Game.Scripts.Core.Projectile newPrefab) {
        var index = GameComponentsLookup.Weapon;
        var component = (WeaponComponent)CreateComponent(index, typeof(WeaponComponent));
        component.IsRanged = newIsRanged;
        component.AttackPoint = newAttackPoint;
