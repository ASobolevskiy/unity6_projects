...
public partial class GameEntity {
    ...
    public void AddWeapon(UnityEngine.Transform newFirePoint, Game.Core.Bullet newBulletPrefab) {
    ...
    public void ReplaceWeapon(UnityEngine.Transform newFirePoint, Game.Core.Bullet newBulletPrefab) {
        var index = GameComponentsLookup.Weapon;
        var component = (WeaponComponent)CreateComponent(index, typeof(WeaponComponent));
        component.FirePoint = newFirePoint;
        component.BulletPrefab = newBulletPrefab;
